...
/** @type {string} */
const CACHE_VERSION = '1751376008|118653791';
/** @type {string} */
const CACHE_PREFIX = 'generic idle tyc-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'tycoon or smth.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["tycoon or smth.html","tycoon or smth.js","tycoon or smth.offline.html","tycoon or smth.icon.png","tycoon or smth.apple-touch-icon.png","tycoon or smth.audio.worklet.js","tycoon or smth.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tycoon or smth.wasm","tycoon or smth.pck"];
